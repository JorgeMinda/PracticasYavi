...
export default function TablaCronograma({
    ...
    return (
        <View className="mx-4 mt-6">
            ...
            <ScrollView
                horizontal
                showsHorizontalScrollIndicator={true} // 🌟 Activado para notar el arrastre hacia S8
                contentContainerStyle={{ flexGrow: 1, paddingRight: 20 }} // 🌟 Clave: Permite expandir el contenido interno
                className="bg-white rounded-2xl border border-gray-200 shadow-sm"
            >
                {/* Envoltura obligatoria para que el contenido horizontal mantenga su estructura en bloque */}
